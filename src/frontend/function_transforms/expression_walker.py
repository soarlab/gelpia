...
default_walk_expand_func_dict.update(zip(BINOPS,
                                         [expand_two  for _ in BINOPS]))
default_walk_expand_func_dict.update(zip(UNOPS,
                                         [expand_one  for _ in UNOPS]))
default_walk_expand_func_dict.update(zip(ATOMS,
                                         [expand_atom for _ in ATOMS]))
...
default_walk_contract_func_dict.update(zip(BINOPS,
                                           [contract_many for _ in BINOPS]))
default_walk_contract_func_dict.update(zip(UNOPS,
                                           [contract_many for _ in UNOPS]))
...
constant_walk_expand_func_dict.update(zip(BINOPS,
                                          [constant_expand_two  for _ in BINOPS]))
constant_walk_expand_func_dict.update(zip(UNOPS,
                                          [constant_expand_one  for _ in UNOPS]))
constant_walk_expand_func_dict.update(zip(ATOMS,
                                          [constant_expand_atom for _ in ATOMS]))
